...
3. 동사 단위: Starter 동사 매트릭스 4형태(평서/의문/부정/짧은 답) 통과 후 `verbUnlockPacks`로 새 동사(예: give) 해금. 표현 Unlock pack과 별 게이트.
...
| 동사 4형태 통과 후 새 동사 해금 | 구현 (`verbUnlockPacks` + matrixFormSuccess) |
