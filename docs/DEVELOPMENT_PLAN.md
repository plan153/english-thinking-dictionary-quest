...
8. 묻기·답하기·시제 매트릭스 모드(`matrix`)가 Active set 표현군에 대해 평서/의문/부정/짧은 답/과거/가까운 미래를 연습한다. 오늘의 말 확장 **이어묻기·이어답하기**는 연결 Q/A 문장을 보여 주고 듣기·말하기 4버튼으로 연습한다 (v1.3.10).
...
1. **D1 → D2** — **완료 2026-07-25 Mac Mini** (pathPrefix=`Project_English`). 절차: [`DAY_LOOP.md`](./DAY_LOOP.md).
...
- [x] 데일리 카피를 **확장 선택(v6)** 에 맞춘다: 순서 클리어가 아니라 듣기/따라하기/이어묻기·답하기/이어말하기/화제전환.
...
- **미구현·보류 SoT = [`BACKLOG.md`](./BACKLOG.md).** **D1·D2 완료 (2026-07-25 Mac Mini)** · pathPrefix=`Project_English`.
