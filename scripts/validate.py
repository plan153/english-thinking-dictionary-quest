...
def main() -> None:
    ...
    for required in ["index.html", "fresh.html", "manifest.webmanifest", "service-worker.js", "README.md", "src/domain/markdown-projection.js", "src/domain/obsidian-sync.js", "src/domain/canon-intake.js", "src/domain/verb-matrix-gate.js", "src/domain/vault-overlay.js", "src/domain/feynman-challenge.js", "src/domain/qa-matrix-generate.js", "src/domain/topic-link.js", "src/domain/expression-contrast.js", "src/domain/answer-classify-helpers.js", "src/domain/expand-turn.js", "src/domain/graph-style.js", "src/domain/progress-store.js", "src/domain/active-speaking-set.js", "src/domain/phrasal-speaking-set.js", "src/domain/english-brain-export.js", "src/domain/next-practice.js", "src/data/thinking-map-sets.js"]:
